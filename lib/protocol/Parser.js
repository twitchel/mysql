...
function Parser(options) {
  ...
  this._prevCompressedPacketNumber = null;
...
Parser.prototype.incrementCompressedPacketNumber = function incrementCompressedPacketNumber() {
  ...
  this._prevCompressedPacketNumber = currentCompressedPacketNumber;
...
Parser.prototype.syncPacketNumber = function syncPacketNumber() {
  if (this._prevCompressedPacketNumber !== null) {
    this._nextPacketNumber           = this._prevCompressedPacketNumber;
    this._prevCompressedPacketNumber = null;
  }
};
...
Parser.prototype._tryReadPacketHeader = function _tryReadPacketHeader() {
  ...
  if (this._packetHeader.number === this._prevCompressedPacketNumber) {
    this.syncPacketNumber();
  }
